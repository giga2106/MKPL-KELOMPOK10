	      ...
	      <option value ="null"></option>
	    	<?php            		
		      while($row = $result3->fetch_array(MYSQLI_ASSOC)) {
		        echo " "?> <option value=" <?php $row["id_kategori"] ?> <?php $row["nama_kategori"].?> </option>"; 
		    <?php}
	    	?> 
	    </select>
	</div>
...
if (isset($_POST['tombol'])) {
	...
	$koneksi->query("INSERT INTO produk 	(id_produk, id_kategori, id_parent, id_merek, nama_produk, harga_produk, berat_produk, foto_produk, deskripsi_produk) 
