<div class="x_panel">
   <div class="x_title">
      <h2 class="text-center">Data Transaksi</h2><br>
      ...
      <table class="table table-striped table-bordered dt-responsive nowrap" id="datatable">
         ...
         <tbody>
            ...
            foreach($data->result() as $key) :
               $batas = (abs(strtotime($key->batas_bayar)));
            ?>
            <tr>
               <td style="vertical-align:middle"><?= $i++; ?></td>
               <td style="vertical-align:middle"><?= $key->id_order; ?></td>
               <td style="vertical-align:middle"><?= $key->nama_pelanggan; ?></td>
               <td style="vertical-align:middle"><?= date('d M Y', strtotime($key->tanggal_pembelian)); ?></td>
               <td style="vertical-align:middle"><?= date('d M Y', strtotime($key->batas_bayar)); ?></td>
